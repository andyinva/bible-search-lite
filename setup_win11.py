...
RELEASE_VERSION = "v1.1.5"  # Update this to match your release tag
...
REM This launcher can be placed anywhere (Desktop, Start Menu, etc.)
...
REM Check if bible_search_lite.py exists
if not exist "bible_search_lite.py" (
    echo ERROR: Cannot find bible_search_lite.py
    echo.
    echo This batch file must be in the same directory as bible_search_lite.py
